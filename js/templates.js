...
mviewer.templates.theme = [
    '<li class="{{cls}}" id="theme-layers-{{id}}" >',
        '<a href="#">',
            '<div class="menu-theme-layers-name"><span class="fa-stack">',
...
mviewer.templates.layerControl = [
    '<li class="{{cls}}" data-layerid="{{layerid}}" data-title=" {{title}}">',
        ...
        '<div class="layerdisplay-legend">',
            ...
            '</div>',
            '<canvas class="vector-legend" id="vector-legend-{{layerid}}" width="0" height="0"></canvas>',
        ...
        '{{/tooltipControl}}',
        '{{#attribution}}',
            '<div class="row mv-layer-options-attribution my-1">',
                '<div class="col-md-12">',
                    '<p>',
                        '<span id="{{layerid}}-attribution">{{{attribution}}} ',
                        '{{#metadata}}',
                            '<a href="#" role="button" id="{{layerid}}-layer-summary" tabindex="10" data-bs-trigger="focus"',
                                ' data-bs-custom-class="popover-layer-summary" data-bs-toggle="popover" data-bs-container="body" class="mv-layer-summary" data-bs-html="true"',
                                ' data-bs-content="">',
                ...
                '<div class="tabs-left">',
                    ...
                    '{{#layers}}',
                        '<li title="{{name}}" class="{{#firstlayer}}active{{/firstlayer}} nav-item" data-layerid="{{layerid}}">',
                            '<a onclick="mviewer.setInfoPanelTitle(this,\'{{panel}}\');" class="{{#firstlayer}}active{{/firstlayer}} nav-link" title="{{name}}" data-bs-target="#slide-{{panel}}-{{id}}" data-bs-toggle="tab">',
    ...
    '<div id="{{panel}}-selector">',
        '<div class="row">',
            '<div class="col-md-12">',
                ...
                '{{#layers}}',
                  '<div class="panel">',
                    '<div class="panel-heading mv-theme caret-toggle {{^firstlayer}}collapsed{{/firstlayer}}" id="dataToggleDiv" data-bs-toggle="collapse" data-parent="#accordion" href="#accordion-{{panel}}-{{id}}" role="tab" id="heading-{{panel}}-{{id}}" data-layerid="{{layerid}}">',
                ...
                '<div class="tabs-left">',
                    ...
                    '{{#layers}}',
                        '<li title="{{name}}" class="{{#firstlayer}}active{{/firstlayer}}" data-layerid="{{layerid}}" {{#initiallayerid}}initiallayerid="{{initiallayerid}}" {{/initiallayerid}}>',
                            '<a onclick="mviewer.setInfoPanelTitle(this,\'{{panel}}\');" title="{{name}}" href="#slide-{{panel}}-{{id}}" data-bs-toggle="tab">',
                                '<span class="fa {{theme_icon}}"></span>',
